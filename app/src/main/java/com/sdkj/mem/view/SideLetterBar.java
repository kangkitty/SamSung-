...
import com.sdkj.sign.utils.DisplayUtil;
...
//		paint.setColor(Color.WHITE);
		...
		paint.setTextSize(DisplayUtil.dip2px(context, 16));
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < mSideLetter .length; i++) {
			...
			paint.setColor(lastIndex==i?Color.parseColor("#FF4081"):Color.parseColor("#6d6d6d"));
